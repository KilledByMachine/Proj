...
QT_MOC_LITERAL(1, 6, 8), // "hide_log"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 8), // "send_int"
QT_MOC_LITERAL(4, 25, 6), // "sended"
QT_MOC_LITERAL(5, 32, 21) // "on_pushButton_clicked"

    },
    "MainW\0hide_log\0\0send_int\0sended\0"
...
void MainW::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->hide_log(); break;
        case 1: _t->send_int((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MainW::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainW::hide_log)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MainW::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MainW::send_int)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void MainW::send_int(QString _t1)
{
